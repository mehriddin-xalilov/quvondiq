...
class DocumentTemplateController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'file'        => ['required', 'file', 'extensions:docx', 'mimetypes:application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/zip,application/x-zip-compressed,application/octet-stream', 'max:10240'],
    ...
    public function update(Request $request, DocumentTemplate $template)
    {
        $validated = $request->validate([
            ...
            'type'        => 'required|in:guvohnoma,certificate',
            'description' => 'nullable|string',
            'file'        => ['nullable', 'file', 'extensions:docx', 'mimetypes:application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/zip,application/x-zip-compressed,application/octet-stream', 'max:10240'],
            'is_active'   => 'nullable|boolean',
        ]);
