        ...
        <form action="{{ route('customers.update', $customer->id) }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <label class="block">
                    ...
                    <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="name" value="{{ old('name', $customer->name) }}" required placeholder="Mijoz ismini kiriting" />
                ...
                <label class="block">
                    ...
                    <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="phone" value="{{ old('phone', $customer->phone) }}" required placeholder="+998901234567" />
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <label class="block">
                    ...
                    <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="telegram_username" value="{{ old('telegram_username', $customer->telegram_username) }}" placeholder="@username" />
                ...
                <!-- Address -->
                 <label class="block">
                    <span>Manzil</span>
                    <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="address" value="{{ old('address', $customer->address) }}" placeholder="Mijoz manzili" />
