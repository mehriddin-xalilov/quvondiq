...
@section('header-title', 'Yangi Mahsulot')
...
<div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6" x-data="{ activeStep: 1 }">
    ...
    <div class="col-span-12 lg:col-span-8">
        <div class="card">
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-5">
                @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            <label class="block">
                                ...
                                <div class="relative flex mt-1.5">
                                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Kod" type="text" name="code" value="{{ old('code') }}" required />
                                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <label class="block">
                                ...
                                <div class="relative flex mt-1.5">
                                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Narx" type="number" step="0.01" name="price" value="{{ old('price') }}" required />
                                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                        ...
                        <label class="block">
                            ...
                            <div class="flex flex-wrap gap-4 mt-2">
                                ...
                                <label class="inline-flex items-center space-x-2">
                                    <input class="form-radio is-basic size-5 rounded-full border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent" name="unit" type="radio" value="dona" {{ old('unit') == 'dona' ? 'checked' : '' }} />
                                    <span>Dona</span>
                                </label>
                                <label class="inline-flex items-center space-x-2">
                                    <input class="form-radio is-basic size-5 rounded-full border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent" name="unit" type="radio" value="qop" {{ old('unit') == 'qop' ? 'checked' : '' }} />
                                    <span>Qop</span>
                                </label>
                                <label class="inline-flex items-center space-x-2">
                                    <input class="form-radio is-basic size-5 rounded-full border-slate-400/70 checked:border-primary checked:bg-primary hover:border-primary focus:border-primary dark:border-navy-400 dark:checked:border-accent dark:checked:bg-accent dark:hover:border-accent dark:focus:border-accent" name="unit" type="radio" value="litr" {{ old('unit') == 'litr' ? 'checked' : '' }} />
                                    <span>Litr</span>
                                </label>
                            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <label class="block">
                                ...
                                <div class="relative flex mt-1.5">
                                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="50" type="number" step="0.01" name="min_stock_level" value="{{ old('min_stock_level', 50) }}" required />
                                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                            ...
                            <label class="block">
                                ...
                                <div class="relative flex mt-1.5">
                                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="500" type="number" step="0.01" name="optimal_stock_level" value="{{ old('optimal_stock_level', 500) }}" required />
                                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                            ...
                            <div class="filepond fp-bordered fp-grid mt-1.5 [--fp-grid:2]">
                                <input type="file" 
                                       ...
                                       x-init="
                                           ...
                                           FilePond.create($el, {
                                               storeAsFile: true,
                                               labelIdle: 'Rasmni yuklang yoki sudrab tashlang',
                                               credits: false,
